...
export const STYLES = {
  ...
  desert: {
    ...
    remap: {
      ...
      WALL_BODY: 'SANDSTONE', WALL_CAP: 'SMOOTH_SAND', RETAIN: 'CUT_SAND',
    },
    cactus: 0.45,
    landmark: { ...MODERN_LANDMARK,
  ...
  snowy: {
    ...
    remap: {
      ...
      WALL_BODY: 'COBBLE', RETAIN: 'COBBLE',
    },
    snow: true,
    landmark: { ...MODERN_LANDMARK,
  ...
  cherry: {
    ...
    remap: {
      ...
      WALL_BODY: 'CALCITE', WALL_CAP: 'CHERRY',
    },
    landmark: { ...MODERN_LANDMARK,
  ...
  medieval: {
    ...
    remap: {
      ...
      LAMP_POST: 'DARK_FENCE', STREET_LIGHT: 'LAMP', RETAIN: 'COBBLE',
    },
    landmark: { ...MODERN_LANDMARK,
